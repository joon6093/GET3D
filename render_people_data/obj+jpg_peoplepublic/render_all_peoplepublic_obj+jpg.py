...
if not os.path.isfile(texture_filepath):
    raise FileNotFoundError(f"Texture file {texture_filepath} does not exist.")
...
# Create texture node and link it
...
cam.location = bbox_center + Vector((0, -3.0, 0))
cam.data.lens = 80
